...
def knn_cv(data_filename, k):
    ...
    for i in range(0, len(dataset_10folds)):
        ...
        y_test = test_set_df[8].values
        test_set_df = test_set_df.drop(8, axis=1)
...
oneNN_performance = knn_cv("./../../../../pima-folds.csv", 1)
fiveNN_performance = knn_cv("./../../../../pima-folds.csv", 5)
print("10-fold cross validation accuracy of 1NN with No CFS: ", oneNN_performance["knn_accuracy"]*100, "%")
print("10-fold cross validation TPR of 1NN with No CFS: ", oneNN_performance["TPR"]*100, "%")
print("10-fold cross validation TNR of 1NN with No CFS: ", oneNN_performance["TNR"]*100, "%")
...
print()
print("10-fold cross validation accuracy of 5NN with No CFS: ", fiveNN_performance["knn_accuracy"]*100, "%")
print("10-fold cross validation TPR of 5NN with No CFS: ", fiveNN_performance["TPR"]*100, "%")
print("10-fold cross validation TNR of 5NN with No CFS: ", fiveNN_performance["TNR"]*100, "%")
